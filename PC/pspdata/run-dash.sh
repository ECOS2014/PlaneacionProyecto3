...
# directory.
#
cd '/Users/paulacastellanos/Documents/ECOS/PROYECTO/Proyecto3/PlaneacionProyecto3/PC/pspdata'

# Runs the Process Dashboard
#
java -Xmx800m -jar '/Users/paulacastellanos/Documents/ECOS/PROYECTO/Proyecto3/PlaneacionProyecto3/PC/pspdash.jar' 'Process Dashboard'
